...
class BookReceiptScreen extends StatefulWidget {
  const BookReceiptScreen({super.key});

  @override
  State<BookReceiptScreen> createState() => _BookReceiptScreenState();
}

class _BookReceiptScreenState extends State<BookReceiptScreen> {
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  height:
                      bodyHeight * (32 / kDeviceHeight), // same height you used
                  child: Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: Color(0xff303030).withAlpha(
                                  (0.08 * 255).round())), // Optional border
                        ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: SvgPicture.asset(
                              ...
                              width: bodyWidth * (15.83 / kDeviceWidth),
                              height: bodyWidth * (15.83 / kDeviceWidth),
                            ),
                          ),
                        ),
                      ),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            width: bodyWidth * (241 / kDeviceWidth),
                            child: Text(receipt['review'] ?? '리뷰가 없습니다.',
                                maxLines: 3,
              ...
              children: [
                TextButton(
                  ...
                  style: TextButton.styleFrom(
                    backgroundColor:
                        Color(0x56698f).withAlpha((0.06 * 255).round()),
                    foregroundColor: Color(0xff303030),
                    minimumSize: Size(bodyWidth * (156 / kDeviceWidth),
                ...
                TextButton(
                  onPressed: () {
                    print(_currentIndex);
                    if (_currentIndex < _bookReceipts.length - 1) {
                      setState(() {
                        _currentIndex++;
                      });
                    }
